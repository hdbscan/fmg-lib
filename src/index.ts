...
const createContext = (
  ...
  return {
    ...
    world: {
      ...
      packFlow: new Uint32Array(0),
      packNeighborOffsets: new Uint32Array(0),
      packNeighbors: new Uint32Array(0),
      packRiver: new Uint32Array(0),
      packRiverCellOffsets: new Uint32Array(1),
      packRiverCells: new Int32Array(0),
...
const toWorldGraph = (context: GenerationContext): WorldGraphV1 => {
  ...
  return {
    ...
    packFlow:
      context.internal.packCellsFlow ?? new Uint32Array(world.packCellCount),
    packNeighborOffsets: world.packNeighborOffsets,
    packNeighbors: world.packNeighbors,
    packRiver:
      context.internal.packCellsRiver ?? new Uint32Array(world.packCellCount),
    packRiverCellOffsets:
      context.internal.packRiverCellOffsets ?? new Uint32Array(1),
    packRiverCells: context.internal.packRiverCells ?? new Int32Array(0),
    ...
    context.internal.cultureCenterSampleIndices
      ? {
          cultureCenterSampleOffsets:
            context.internal.cultureCenterSampleOffsets,
          cultureCenterSamples: context.internal.cultureCenterSamples,
